            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-4 max-w-[360px] lg:mb-16">
                ...
                <p className="footer-description">
                  Shoppiem is a personal shopping assistant powered by ChatGPT. Get instant answers to all your product questions and save time and money while shopping on Amazon.
                </p>
